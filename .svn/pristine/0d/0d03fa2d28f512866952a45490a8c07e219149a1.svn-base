...
using HCP.ClinicalServices.DL.Repository;
using HCP.ClinicalServices.WebAPI.Utility;
using HCP.ClinicalServices.DL.Entities;

namespace HCP.ClinicalServices.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISpecialtyCodesRepository, SpecialtyCodesRepository>();
