...
namespace HCP.ClinicalServices.WebAPI.Controllers
{
    ...
    public class SpecialtyController : ControllerBase
    {
        ...
        /// <summary>
        /// Get All Doctor Link for BusinessKey and Specialty
        /// UI Reffered - Clinic Doctor Link,
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetDoctorListByBKeySpecialtyId(int businessKey, int specialtyId)
        {
            var msg = await _SpecialtyRepository.GetDoctorListByBKeySpecialtyId(businessKey, specialtyId);
            return Ok(msg);
        }
    }
}
